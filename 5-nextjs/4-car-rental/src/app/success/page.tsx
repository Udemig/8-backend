  ...
  return (
    <div className="max-w-180 mx-auto px-6 lg:px-16 py-12 flex flex-col gap-6">
      <div className="bg-card rounded-card p-8 flex flex-col items-center gap-3 text-center">
        <span className="size-16 rounded-pill bg-primary/10 text-primary flex items-center justify-center">
          <CheckCircle2 size={36} strokeWidth={2.25} />
        </span>
        <h1 className="text-secondary-500 text-2xl font-bold">Ödeme Başarılı</h1>
        <p className="text-secondary-400 text-sm">Rezervasyonunuz oluşturuldu. Detayları aşağıda bulabilirsiniz.</p>
