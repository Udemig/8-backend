...
- Normal şartlarda filtrelme kullanılılarak yapılan sorgulardam mongodb bütün belgeleri inceleyip filtrelemeye uygun olanları döndürür

- **Index Yoksa**
- 1 milyon kayıt varsa hepsini kontrol eder koşula uyanları (2500) getirir

- **Index Varsa**
- Veritabanında verileri sıralı bir şekilde saklandığı için sadece 2500 kaydı kontrol eder ve onları getirir
...
- **Dezavantaj**
- Diskte alan kaplar
- Inser/Update sorguları daha yabaş gerçekleşir

- **Sonuç**
- Bütün alanlara index uygulamak bizi zarara sokucağından kullanıcılar tarafından en çok yapılan sorgularda uygulamak en mantıklı yöntemdir
...
- Yukarıdaki index aşağıdaki sorguyu optimize eder
