...
class CustomerService {
  ...
  async ManageCart(customerId, product, qty, isRemove) {
    try {
      if (!customerId || !product) throw new APIError("No customerId or product provided", STATUS_CODES.BAD_REQUEST);
  ...
  // Webhook için kullanılacak
  // Diğer servislerden gelen haberlere göre gerekli fonksiyonları çağırcak
